...
if(isset($_GET['id']) && is_numeric($_GET['id'])){
    ...
    if(isset($_SESSION['carrito'])){ //SI EL CARRITO EXISTE
        //SI EL software EXISTE EN EL CARRITO

        if(array_key_exists($id,$_SESSION['carrito'])){
            actualizarsoftware($id);
        }else{
            //  SI EL CARRITO NO EXISTE EN EL CARRITO
            agregarSoftware($resultado, $id);
        }
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">App Center</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav pull-right">
            <li>
              <a href="" class="btn">CARRITO <span class="badge"><?php print cantidadsoftwares(); ?></span></a>
            </li> 
          </ul>
        </div><!--/.nav-collapse -->
      </div>
